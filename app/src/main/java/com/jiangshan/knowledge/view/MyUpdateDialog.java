 ...
 */
public class MyUpdateDialog extends BaseDialog implements View.OnClickListener, IDownloadEventHandler {
     ...
     * @return 更新提示
     */
    public static MyUpdateDialog newInstance(@NonNull Context context, @NonNull UpdateEntity updateEntity, @NonNull IPrompterProxy prompterProxy, PromptEntity promptEntity) {
    ...
    private MyUpdateDialog setIPrompterProxy(IPrompterProxy prompterProxy) {
...
//                ActivityCompat.requestPermissions(scanForActivity(getContext()), new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_CODE_REQUEST_PERMISSIONS);
//            } else {
                installApp();
//            }
