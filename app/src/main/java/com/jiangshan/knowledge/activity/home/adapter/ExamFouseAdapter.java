 ...
 */
public class ExamFouseAdapter extends BaseQuickAdapter<Article, BaseViewHolder> implements LoadMoreModule {

    public ExamFouseAdapter(int layoutResId, @Nullable List<Article> data) {
